...
export default function Navbar() {
  ...
  return (
    <>
      {/* Top Navbar */}
      <nav aria-label="Main navigation" className="sticky top-0 z-50 border-b border-gray-200/80 bg-white/80 backdrop-blur-lg dark:border-gray-800 dark:bg-gray-900/80">
      ...
      {/* Mobile Bottom Nav */}
      <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-gray-200/80 bg-white/90 backdrop-blur-lg dark:border-gray-700/80 dark:bg-gray-900/90 md:hidden">
